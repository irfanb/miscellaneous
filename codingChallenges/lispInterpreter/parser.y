...
%token  PLUS MINUS TIMES FORWARDSLASH SEMICOLON COMMA PERIOD EQUAL NOTEQUAL LEQ GEQ IDENT NUMBER UNKNOWN STRINGATOM SYMBOLATOM BEGINEXPRESSION ENDEXPRESSION SINGLEQUOTE
LESSTHAN GREATERTHAN DIVIDE
%start exprs
...
atom: STRINGATOM 
    ...
    | PLUS | MINUS | LEQ | GEQ | LESSTHAN | GREATERTHAN | TIMES | DIVIDE
    {
	//LOG(INFO) << $1.toString();
	//$$ = Operator($1);
    }
